...
interface TLikeBtnProps {
  favoriteActive?: boolean | undefined;
  handleFilmToFavorites: () => void;
}

export const LikeBtn: FC<TLikeBtnProps> = ({ favoriteActive, handleFilmToFavorites }) => {
  return (
    <a href="#" className="action-list__link btn action-list__link--like" onClick={handleFilmToFavorites}>
      {favoriteActive ?
        ...
        :
        <svg className='action-list__like-svg' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
